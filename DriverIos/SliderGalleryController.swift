...
class SliderGalleryController: UIViewController,UIScrollViewDelegate{
    ...
    func configurePageController() {
        ...
        self.pageControl!.setValue(UIImage(named:"bannerSwitch02.png"), forKey: "pageImage")
        self.pageControl!.setValue(UIImage(named:"bannerSwitch01.png"), forKey: "currentPageImage")
